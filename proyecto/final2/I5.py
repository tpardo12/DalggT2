#Autores:
#Tomas Alejandro Pardo R.
#Maria Alejandra Lizarazo P.
import sys
                ...
                for cm_prev in range(C):
                    ...
                    for di in [-1, 0, 1]:
                        ...
                        for dm in [-1, 0, 1]:
                            ...
                            if ci_new == cm_new:
                                primera_vez=True
                                mismo =True # Evitar que Indiana y Marion estén en la misma celda
                            total=-1
                            if not(no_sigue_I) and not(no_sigue_M)and(matriz[row][ci_new] != -1 and matriz[row][cm_new] != -1) and (not mismo) :
...
#             # Abriendo en modo de adjuntar ('a') y escribiendo inmediatamente el resultado
